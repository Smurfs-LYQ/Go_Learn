...
15. > TCP粘包
    ...
    - 什么是粘包
      ...
      比如说客户端分10次发送的数据，但是在服务端并没有成功的输出10次，而是多条数据"粘"在了一起。这个问题就是由于粘包造成的。
    ...
    - 为什么会出现粘包
     ...
     - 解决办法
       ...
       我们可以自己定义一个协议，数据包的前四个字节为包头(存储的是发送的数据的长度)，第四个字节往后保存的是真正的数据。
...
16. > Go语言实现UDP通信
 ...
 17. > 大端和小端的概念
     ...
     - [知乎专栏](https://zhuanlan.zhihu.com/p/36149865)
